...
<html lang="en">
<head>
  <title>Developer' Profile - FasTech</title>
  <meta charset="utf-8">
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 text-center heading-section ftco-animate">
          <span class="subheading1">THE PEOPLE BEHIND</span>
        ...
        <div class="col-md-12">
          <div class="item">
            <div class="item">
              <div class="testimony-wrap p-4 text-center">
                ...
                <div class="text">
                  <p class="name">Vince John C. Perez</p>
                  <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                  <p class="mb-4">Email Address: qvjcperez@tip.edu.ph<br>Phone Number: 09359148135<br>Home Address: Unit 5315 Flora Vista, Peacock St., Fairview, Brgy. Commonwealth, Quezon City, Philippines</p>
                </div>
              </div>
            </div>
            <br><br>
            <div class="item">
              <div class="testimony-wrap p-4 text-center">
                <div class="user-img mb-4" style="background-image: url(images/p2.PNG)">
                </div>
                <div class="text">
                  <p class="name">Kestrel Kellner Garcia - Cervantes</p>
                  <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                  <p class="mb-4">Email Address: qkkgcervantes@tip.edu.ph<br>Phone Number: 09999231139<br>Home Address:
                    #24 Harvard Street, Brgy. Socorro, Cubao, Quezon City, Philippines</p>
                </div>
              </div>
            </div>
            <br><br>
            <div class="testimony-wrap p-4 text-center">
              ...
              <div class="text">
                <p class="name">John Micko C. Rapanot</p>
                <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                <p class="mb-4">Email Address: qjmcrapanot@tip.edu.ph<br>Phone Number: 09194282431<br>Home Address: 17C
                  Daffodil Street, Grandvalley Phase 3 Barangay Mahabang Parang Angono Rizal, Philippines</p>
          ...
          <div class="item">
            <div class="testimony-wrap p-4 text-center">
              ...
              <div class="text">
                <p class="name">John Philip D. Garcia</p>
                <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                <p class="mb-4">Email Address: qjpdgarcia@tip.edu.ph<br>Phone Number: 09453882426<br>Home Address: #18
                  Botocan Street, Brgy. Tandang Sora, Quezon City, Philippines</p>
              </div>
            </div>
          </div>
          <br><br>
          <div class="item">
            <div class="testimony-wrap p-4 text-center">
              ...
              <div class="text">
                <p class="name">Hanz Renzo S. Rondin</p>
                <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                <p class="mb-4">Email Address: qhrsrondin@tip.edu.ph<br>Phone Number: 09282626546<br>Home Address: 163
                  Kagitingan St. Calumpang Marikina City, Philippines</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="testimony-wrap p-4 text-center">
              <div class="user-img mb-4" style="background-image: url(images/p6.PNG)">
              </div>
              <div class="text">
                <p class="name">Andrea Joy P. Evangelista</p>
                <span class="position">Bachelor's of Science in Information Technology - TIPQC</span>
                <p class="mb-4">Email Address: qhrsrondin@tip.edu.ph<br>Phone Number: 09975627347<br>Home Address: 40 E.
                  Abello St., IVC Marikina City, Philippines</p>
              </div>
            </div>
          </div>
        </div>

...
<html lang="en">
<head>
	<title>Administrator Access - FasTech</title>
	<meta charset="utf-8">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="forpayment.php" class="nav-link">For Payment Appointments</a></li>
					...
					<li class="nav-item"><a href="cancelled.php" class="nav-link">Cancelled Appointments</a></li>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3 ftco-animate">
				<div class="col-md-12 text-center heading-section ftco-animate">
					<br><br><br><br><br>
					<span class="subheading1">FASTECH DATABASE</span>
					<h2>For Payment Appointments</h2>
					<div class="col-lg-12">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php
									...
									$sql = "SELECT * FROM appointments WHERE `status` = 'payment'";
